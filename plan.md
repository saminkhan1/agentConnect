...
- On-chain identity + trust (ERC-8004 identity/reputation registries, ERC-8118 smart-contract enforcement, ERC-8128 Ethereum-bound HTTP signatures) — revisit post-PMF if cross-platform agent identity becomes a real requirement
- W3C DIDs / Verifiable Credentials for open agent mesh scenarios
- OBO (On-Behalf-Of) OAuth 2.1 with AI-specific JWT claims for cross-org delegation chains
