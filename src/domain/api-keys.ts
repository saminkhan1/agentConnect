...
function parseHashParts(storedHash: string): { salt: string; keyHex: string } | null {
...
export function parseApiKeyFromAuthorizationHeader(headerValue: string): ParsedApiKey | null {
