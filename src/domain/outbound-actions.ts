...
export const OUTBOUND_ACTION_REJECTED_STATUSES = new Set([
	400, 403, 404, 409, 422,
]);

export const outboundActionTypeSchema = z.enum(
	outboundActionTypeEnum.enumValues,
);
export const outboundActionStateSchema = z.enum(
	outboundActionStateEnum.enumValues,
);
...
export function parseCachedProviderError(
	value: unknown,
