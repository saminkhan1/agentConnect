...
// Runtime list sourced from Stripe's published Issuing card spending-control category values.
export const STRIPE_ISSUING_ALLOWED_CATEGORY_VALUES = [
...
export const stripeIssuingMerchantCountrySchema = z
  ...
  .refine(isIso3166Alpha2CountryCode, {
