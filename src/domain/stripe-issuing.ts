...
export const stripeIssuingSpendingLimitIntervalSchema = z.enum(
	stripeIssuingSpendingLimitIntervals,
);
...
export const stripeIssuingMerchantCountrySchema = z
	...
	.trim()
	.transform(
		(value): Stripe.Issuing.CardholderCreateParams.Billing.Address["country"] =>
			value.toUpperCase(),
	)
