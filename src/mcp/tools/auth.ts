...
export function withOptionalAuthorizationSchema<T extends Record<string, z.ZodType>>(
...
export function resolveToolAuthorization(session: McpSessionContext, inputAuthorization?: string) {
