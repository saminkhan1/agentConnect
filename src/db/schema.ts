...
export const outboundActionTypeEnum = pgEnum("outbound_action_type", [
	"send_email",
	"reply_email",
]);
...
export const webhookSubscriptionDeliveryModeEnum = pgEnum(
	"webhook_subscription_delivery_mode",
	["canonical_event", "openclaw_hook_agent", "openclaw_hook_wake"],
);
...
export const outboundActions = pgTable(
	...
	(table) => [
		...
		index("outbound_actions_org_idempotency_key_idx").on(
			table.orgId,
			table.idempotencyKey,
		),
...
export const webhookSubscriptions = pgTable(
	"webhook_subscriptions",
	{
		...
		staticHeaders: jsonb("static_headers")
	...
	(table) => [
		...
		index("webhook_subscriptions_org_created_at_idx").on(
			table.orgId,
...
export const webhookDeliveries = pgTable(
	"webhook_deliveries",
	{
		...
		lastStatus: webhookDeliveryStatusEnum("last_status")
			.notNull()
			.default("pending"),
